...
var RestService = (function () {
    function RestService(baseURL, tokenProvider, apiCallWrapper) {
        this.tokenProvider = tokenProvider;
        this.apiClient = new APIClient_1.APIClient(baseURL, new ContentCodec_1.JSONSerializer(), new ContentCodec_1.JSONDeserializer(), apiCallWrapper);
    }
